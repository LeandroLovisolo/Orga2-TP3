...
La IDT (Interrupt Descriptor Table) es la encargada de almacenar los descriptores de interrupciones, la misma tiene un total de 256 entradas, las cuales se corresponden con todos los distintos tipos de interruptores que maneja el microprocesador. Las entradas 2, 15 y de la 20 a la 31 estan reservadas por intel, por lo que no hay que utilizarlas, para el resto de las entradas, tuvimos que ponerle los descriptores correctos para que apunten a la rutina correspondiente.
...
En $numero$ va la posición de la IDT correspondiente, en $seg$ el segmento que utilizara y en $atrr$ los atributos correctos.
Utilizando esta macro definimos los descriptores de interrupciones
