...
\section{Desarrollo}
\subsection{Ejercicio 1: Completando la tabla de descriptores de segmento GDT}
...
\begin{itemize}
 \item $limit_0_15 = 0xFFFF$ (Se encuentran los primeros $16$ bits que indican el limite del segmento, poniendo este valor, como la base es $0$ obtenemos segmentos de $2GB$ como fue pedido en el enunciado del TP).
 \item $base_0_15 = 0$ 
 \item $base_23_16 = 0$
 ...
 \item $limit_16_19 = 0x7$ (acá están los últimos $4$ bits del limite).
 \item $avl = 0$
...
\end{itemize}
Lo demas registros deben ser resguardados por la interrupción en caso que los utilize.\\
