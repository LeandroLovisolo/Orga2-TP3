...
La tarea de la interrupción $32$ (reloj) tiene 2 funciones:

\begin{enumerate}
 \item Imprimir el proximo estado del reloj.
 \item Ejecutar la función sched que llama al scheduler.
\end{enumerate}

La impresión del pŕoximo estado del reloj se realiza ejecutando la función $proximo\_reloj$ creada por la cátedra  la cual se encarga de actualizar correctamente el estado de reloj.
...
La interrupción $33$ es la encargada de ver si hay que pausar o reanudar el juego. Esta realiza una lectura del estado del teclado y dependiendo el resultado, setea el espacio de memoria definido por la variable  $pausarReanudar$ (declarada en $sched.c$) en $1$ o en $0$.
...
Una vez seteado $pausarReanudar$, el scheduler se encargará más tarde de pausar o reanudar el juego.
