...
Al resetear el PIC, las interrupciones de hardware quedan mapeadas en el área de interrupciones disponibles provistas por Intel, pudiendose luego ser utilizadas correctamente.
...
Si en cambio las interrupciones no están definidas en la IDT, el procesador produce una excepción de protección general.
