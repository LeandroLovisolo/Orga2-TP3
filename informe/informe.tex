...
(ESTO NO ES DE 20 A 32 bits?)
la función $habilitar\_A20$ creada por la catedra sirve para poder trabajar con espacios de memoria por encima del primer Mbyte de memoria, la misma debe ser llamada antes de pasar al modo protegido, ya que si no se genera un general protection $\#GP$.
