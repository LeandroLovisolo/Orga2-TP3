...
void idt_inicializar() {
	...
	IDT_ENTRY(32, KERNEL_CODE_SEGMENT, GATE_TYPE);
	IDT_ENTRY(33, KERNEL_CODE_SEGMENT, GATE_TYPE);
	//IDT_ENTRY(128, KERNEL_CODE_SEGMENT, GATE_TYPE);
	IDT_ENTRY(144, KERNEL_CODE_SEGMENT, GATE_TYPE);
}
